...
function HomePage() {
  ...
  return (
    <div id="content" className="h-full w-full flex flex-row">
      <div id="sidebar" className="w-[40%] flex flex-col max-[981px]:w-full min-[981px]:max-w-[325px] h-full max-[981px]:bg-white bg-purple-100 rounded-l-md max-[981px]:rounded-r-md max-[981px]:pt-4">
