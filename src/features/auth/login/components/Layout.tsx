...
export const Layout: React.FC<Props> = ({ children }) => {
  return (
    <section className="gap-4 flex justify-center items-center flex-col rounded-lg p-10 text-left">
      <img className="mb-6" src={slackLogo} width={130} height="auto" alt="Slack Logo" />
      ...
      <div className="flex justify-center items-center gap-2 mt-2 flex-col w-full">
        <Button className=" border-blue-500 text-blue-500 border-2 border-solid rounded-md w-full font-semibold">
          <img className="mr-4" src={googleIcon} width={30} height="auto" alt="Google Logo Icon" />
          Continue with Google
        </Button>
        <Button className=" border-black border-2 border-solid rounded-md w-full">
          <img className="mr-4" src={appleIcon} width={30} height="auto" alt="Apple Logo Icon" />
          Continue with Apple
        </Button>
      </div>
